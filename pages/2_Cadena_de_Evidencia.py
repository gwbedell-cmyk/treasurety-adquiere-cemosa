...
<div style="margin-bottom:2rem;">
  <span class="eyebrow">CADENA DE EVIDENCIA</span>
  <h1 style="color:#F0F7FF;font-size:2.2rem;font-weight:800;margin:0.3rem 0 0.6rem;">
    Tres entregas. Una cadena criptográfica.
  </h1>
  <p style="color:#8BA3C0;font-size:1rem;max-width:760px;line-height:1.7;">
    Cada CER se encadena con el anterior mediante hash. La cadena reconstruye la historia
    completa de las entregas.
  </p>
</div>
...
with col_chain:
    ...
    <div class="chain-container">
      ...
      <div class="chain-item">
        ...
        <div class="chain-hash-small">
          SHA-256 &nbsp;·&nbsp; 7F4A8C91...C2E04751
        </div>
      </div>
...
with col_summary:
    ...
    <div class="card" style="margin-bottom:1rem;">
      ...
      <div class="card-row">
        <span class="card-label">Primera recepción</span>
        <span class="card-value">10:24</span>
      </div>
      <div class="card-row">
        <span class="card-label">Segunda recepción</span>
        <span class="card-value">11:47</span>
      </div>
      <div class="card-row">
        <span class="card-label">Última recepción</span>
        <span class="card-value">13:09</span>
      </div>
      <div class="card-row" style="border-bottom:none;">
        <span class="card-label">Duración total</span>
        <span class="card-value">2h 45min</span>
      </div>
    </div>
    ...
    <div class="card" style="margin-bottom:1rem;">
      ...
      <div class="hash-block" style="font-size:0.72rem;">
        <span class="hash-label">SHA-256 · CADENA COMPLETA</span>
        2E8F4A1D7C3B590E<br>
        6A2D481F9C5E207B<br>
        4F1A3C8D2E9B0F6A
      </div>
      <div style="margin-top:1rem;text-align:center;">
        <span class="badge-green">&#10003; CADENA ÍNTEGRA</span>
      </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
    <div class="info-box">
      El hash de la Cadena de Evidencia encapsula los tres CERs. Si cualquier dato cambia,
      el hash cambia. Cualquier auditor puede verificarlo años después.
    </div>
    """, unsafe_allow_html=True)
